...
async function ensureDependencyDashboard(config, allBranches, packageFiles = {}, configMigrationRes) {
	...
	if (config.dependencyDashboardReportAbandonment) issueBody += getAbandonedPackagesMd(config, packageFiles);
...
function getAbandonedPackagesMd(config, packageFiles) {
