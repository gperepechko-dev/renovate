...
//#region lib/modules/platform/gerrit/schema.ts
/**
...
*/
const GerritAccountInfo = z.object({
	_account_id: z.number(),
	username: z.string().optional()
});
const GerritLabelInfo = z.object({
	approved: GerritAccountInfo.optional(),
	rejected: GerritAccountInfo.optional(),
	blocking: z.boolean().optional()
});
const GerritActionInfo = z.object({
	method: z.string().optional(),
	enabled: z.boolean().optional()
});
const GerritRevisionInfo = z.object({
...
const GerritChangeMessageInfo = z.object({
	id: z.string(),
	message: z.string(),
	tag: z.string().optional()
});
const GerritChange = z.object({
	branch: z.string(),
	change_id: z.string(),
	subject: z.string(),
	status: z.enum([
	...
	reviewers: z.object({ REVIEWER: LooseArray(GerritAccountInfo).optional() }).optional(),
...
const GerritChanges = LooseArray(GerritChange);
const GerritLabelTypeInfo = z.object({
	values: z.record(z.coerce.number(), z.string()),
	default_value: z.number()
});
const GerritProjectInfo = z.object({
	id: z.string(),
	name: z.string(),
	state: z.enum([
		"ACTIVE",
...
const GerritBranchInfo = z.object({
	ref: z.string(),
	revision: z.string()
});
const GerritMergeableInfo = z.object({
	submit_type: z.enum([
		"MERGE_IF_NECESSARY",
		"FAST_FORWARD_ONLY",
		"REBASE_IF_NECESSARY",
...
const GerritRepos = z.record(z.string(), z.object({}).loose());
const GerritChangeMessages = LooseArray(GerritChangeMessageInfo);
//#endregion
export { GerritBranchInfo, GerritChange, GerritChangeMessages, GerritChanges, GerritMergeableInfo, GerritProjectInfo, GerritRepos };
