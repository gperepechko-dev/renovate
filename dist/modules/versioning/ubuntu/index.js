...
const urls = ["[Ubuntu meta-release](https://changelogs.ubuntu.com/meta-release)", "[Ubuntu distro info data](https://debian.pages.debian.net/distro-info-data/ubuntu.csv)"];
